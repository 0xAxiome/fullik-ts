...
export var math = {
    ...
    findAngle: function (b0, b1) {
        ...
        var a = b0.end.minus(b1.end).lengthSq(), b = b0.end.minus(b0.start).lengthSq(), c = b1.end.minus(b0.start).lengthSq(), angle, r, sign;
    ...
    unwrapDeg: function (r) { return (r - (Math.floor((r + 180) / 360)) * 360); },
    unwrapRad: function (r) { return (r - (Math.floor((r + Math.PI) / (2 * Math.PI))) * 2 * Math.PI); },
